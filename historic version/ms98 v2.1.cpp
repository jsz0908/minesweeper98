...
//局面统计:
bool StatsMode = false;				//局面统计模式开关
int safe_cell = 0;					//安全格子数
int flag_count = 0;					//插旗数
int Click = 0;						//操作次数

int cursor_x = 0, cursor_y = 0;		// 记录当前光标位置
...
void Main_Menu() {
	system("cls");
	SetColor(COLOR_Menu);
	cout << "###############minesweeper98 release v2.1#############" << endl;
...
void Exit() {
	...
	SetColor(COLOR_Menu);
	cout << "---------------------------------------------------" << endl;
	cout << "ms98 release v2.1还会继续开发" << endl;
	cout << "后续版本会陆续增加新功能" << endl;
	cout << "---------------------------------------------------" << endl;
...
void About() {
	...
	SetColor(COLOR_Menu);
	cout << "---------------------------------------------------" << endl;
	cout << "ms98 release v2.1 还会继续开发" << endl;
	cout << "后续版本会陆续增加新功能" << endl;
	cout << "---------------------------------------------------" << endl;
	cout << "作者:jsz0908" << endl;
	cout << "Github:https://github.com/jsz0908/" << endl;
